<footer class="bg-gray-900 text-gray-300 py-16">
    <div class="container-custom">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <!-- Services -->
            <div>
                <h3 class="text-white font-bold mb-6 text-lg">Dịch vụ</h3>
                <ul class="space-y-4 text-sm">
                    <li><a href="#" class="hover:text-primary transition-colors">Sửa chữa Laptop - PC</a></li>
                    <li><a href="#" class="hover:text-primary transition-colors">Bảo trì máy tính văn phòng</a></li>
                    <li><a href="#" class="hover:text-primary transition-colors">Nạp mực máy in tận nơi</a></li>
                    <li><a href="#" class="hover:text-primary transition-colors">Lắp đặt Camera an ninh</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex gap-3">
                        ...
                        <span>80/28 Đặng Văn Ngữ, P.10, Q.Phú Nhuận, TP.HCM</span>
                    </li>
                    <li class="flex gap-3">
                    ...
                    <li class="flex gap-3">
                        ...
                        <span>info@auvietphat.com.vn</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-white/10 mt-16 pt-8 text-center text-xs text-gray-500">
            <p>© 2024 Âu Việt Phát Technology. All rights reserved. Designed with ❤️ by AVP Team.</p>
        </div>
    </div>
</footer>
